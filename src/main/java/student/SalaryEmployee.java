...
public class SalaryEmployee extends AbstractEmployee {
     ...
     */
    static private final BigDecimal SALARY_EMPLOYEE_DIVISOR = new BigDecimal(24);
    ...
    public BigDecimal calculateGrossPay(double hoursWorked) {
        BigDecimal hourlyPayRate = payRate.divide(SalaryEmployee.SALARY_EMPLOYEE_DIVISOR, 2,
